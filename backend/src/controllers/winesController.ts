...
import { getWinesByOrders, getWinesByRevenue, getWinesBySold } from "../models/wines";

export const getWines = async (req: FastifyRequest<{ Querystring: WineQuery }>, reply: FastifyReply) =>  {
